# #This module contains constant variables, the path to the directories, and
# initial settings. 
...
CATEGORICAL_FEATURES=['Gender','Married','Dependents','Education','Self_Employed','Credit_History','Property_Area'] #Categorical
